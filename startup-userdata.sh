...
export CENTRIFYCC_DOWNLOAD_PREFIX=https://raw.githubusercontent.com/marcozj/AWS-Automation/master
...
export CENTRIFY_GIT_PREFIX_URL=https://raw.githubusercontent.com/maroczj/AWS-Automation/master
